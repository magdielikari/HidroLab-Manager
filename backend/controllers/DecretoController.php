...
class DecretoController extends Controller
{
    ...
    {
        if(Yii::$app->user->can('decreto-index'))
        {
    ...
    {
        if(Yii::$app->user->can('decreto-view'))
        {    
    ...
    {
        if(Yii::$app->user->can('decreto-create'))
        {    
            $model = new Decreto();
    ...
    {
        if(Yii::$app->user->can('decreto-update'))
        {    
            $model = $this->findModel($id);
            if ($model->load(Yii::$app->request->post())) {
                $model->save();
    ...
    {
        if(Yii::$app->user->can('decreto-delete'))
        {    
