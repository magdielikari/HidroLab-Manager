...
class SubtipoController extends Controller
{
    ...
    {
        if(Yii::$app->user->can('subtipo-index'))
        {    
    ...
    {
        if(Yii::$app->user->can('subtipo-view'))
        {   
    ...
    {
        if(Yii::$app->user->can('subtipo-create'))
        {    
            $model = new Subtipo();
    ...
    {
        if(Yii::$app->user->can('subtipo-update'))
        {    
            $model = $this->findModel($id);
            if ($model->load(Yii::$app->request->post())) {
                $model->save();
    ...
    {
        if(Yii::$app->user->can('subtipo-delete'))
        {    
