...
<div class="costo-predeterminados-index">
    ...
    <p>
        <?= Html::button(Yii::t('models', 'Create Predeterminados'), ['value'=>Url::to('costo-predeterminados/create'),
        'class' => 'btn btn-success modalButton', 'data-title'=>'Crear Predeterminados']) ?>
    </p>
