...
<div class="caracterizacion-has-departamento-index">
    ...
    <p>
        <?= Html::button(Yii::t('models', 'Create Caracterizacion Has Departamento'), ['value'=>Url::to('create'),
        'class' => 'btn btn-success modalButton','data-title'=>'Crear Caracterizacion has Departamento']) ?>
    </p>
