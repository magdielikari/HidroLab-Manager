...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 24, 2015 at 03:41 PM
...
CREATE TABLE `caracterizacion_has_departamento` (
...
CREATE TABLE `caracterizacion_has_equipos` (
  `Caracterizacion_id` smallint(5) UNSIGNED NOT NULL,
...
CREATE TABLE `costopredeterminados` (
  `id` int(10) UNSIGNED NOT NULL,
  `nombre` varchar(45) NOT NULL,
...
CREATE TABLE `costopredeterminados_has_administrativos` (
...
CREATE TABLE `costopredeterminados_has_parametros` (
  `CostoPredeterminados_id` int(10) UNSIGNED NOT NULL,
...
CREATE TABLE `costopredeterminados_has_prestaciones` (
  `CostoPredeterminados_id` int(10) UNSIGNED NOT NULL,
...
CREATE TABLE `departamento_has_decreto` (
  `Departamento_id` tinyint(3) UNSIGNED NOT NULL,
  `Decreto_id` tinyint(3) UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `equipos_has_general` (
  `Equipos_id` smallint(5) UNSIGNED NOT NULL,
  `General_id` int(10) UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `general` (`id`, `copias`, `caudal`, `analisis`, `Departamento_id`, `Decreto_id`, `Clientes_id`, `Vendedor_id`) VALUES
(62, 1, 'Aplica', 'Analisis y Muestreo', 1, 1, 1, 1);
...
CREATE TABLE `general_has_subtipo` (
  `General_id` int(10) UNSIGNED NOT NULL,
...
CREATE TABLE `parametros_has_muestras` (
  `Parametros_id` int(10) UNSIGNED NOT NULL,
...
CREATE TABLE `parametros_has_muestras_has_costopredeterminados` (
...
CREATE TABLE `rama_has_caracterizacion` (
...
(3, 'nosthertus', '2n8Ce-BE67E-YNkmzhVXcnkzVPmxx9fN', '$2y$13$JAwropJLIR/6K6LfPZ4lcewPIulep24LNC/f.91PTXebCE8DOT/2O', NULL, 'darlfreal17@hotmail.com', 10, 1450851326, 1450851326);
...
INSERT INTO `vendedor` (`id`, `Puesto_id`, `user_id`) VALUES
(1, 1, 1);
...
ALTER TABLE `caracterizacion`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_Caracterizacion_Equipos1_idx` (`Equipos_id`);

--
-- Indexes for table `caracterizacion_has_departamento`
--
ALTER TABLE `caracterizacion_has_departamento`
  ADD PRIMARY KEY (`Caracterizacion_id`,`Departamento_id`),
  ADD KEY `fk_Caracterizacion_has_Departamento_Departamento1_idx` (`Departamento_id`),
  ADD KEY `fk_Caracterizacion_has_Departamento_Caracterizacion1_idx` (`Caracterizacion_id`);

--
-- Indexes for table `caracterizacion_has_equipos`
--
ALTER TABLE `caracterizacion_has_equipos`
  ADD PRIMARY KEY (`Caracterizacion_id`,`Equipos_id`),
  ADD KEY `fk_Caracterizacion_has_Equipos_Equipos1_idx` (`Equipos_id`),
  ADD KEY `fk_Caracterizacion_has_Equipos_Caracterizacion1_idx` (`Caracterizacion_id`);

--
-- Indexes for table `carea`
--
ALTER TABLE `carea`
  ADD PRIMARY KEY (`id`);
...
ALTER TABLE `celular`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_Celular_CArea1_idx` (`CArea_id`),
  ADD KEY `fk_Celular_Clientes1_idx` (`Clientes_id`),
  ADD KEY `fk_Celular_Vendedor1_idx` (`Vendedor_id`);
...
--
-- Indexes for table `codigoanalisis`
--
ALTER TABLE `codigoanalisis`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `codigomuestra`
--
ALTER TABLE `codigomuestra`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `costopredeterminados`
--
ALTER TABLE `costopredeterminados`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_CostoPredeterminados_Moneda1_idx` (`Moneda_id`);

--
-- Indexes for table `costopredeterminados_has_administrativos`
--
ALTER TABLE `costopredeterminados_has_administrativos`
  ADD PRIMARY KEY (`CostoPredeterminados_id`,`Administrativos_id`),
  ADD KEY `fk_CostoPredeterminados_has_Administrativos_Administrativos_idx` (`Administrativos_id`),
  ADD KEY `fk_CostoPredeterminados_has_Administrativos_CostoPredetermi_idx` (`CostoPredeterminados_id`);

--
-- Indexes for table `costopredeterminados_has_parametros`
--
ALTER TABLE `costopredeterminados_has_parametros`
  ADD PRIMARY KEY (`CostoPredeterminados_id`,`Parametros_id`),
  ADD KEY `fk_CostoPredeterminados_has_Parametros_Parametros1_idx` (`Parametros_id`),
  ADD KEY `fk_CostoPredeterminados_has_Parametros_CostoPredeterminados_idx` (`CostoPredeterminados_id`);

--
-- Indexes for table `costopredeterminados_has_prestaciones`
--
ALTER TABLE `costopredeterminados_has_prestaciones`
  ADD PRIMARY KEY (`CostoPredeterminados_id`,`Prestaciones_id`),
  ADD KEY `fk_CostoPredeterminados_has_Prestaciones_Prestaciones1_idx` (`Prestaciones_id`),
  ADD KEY `fk_CostoPredeterminados_has_Prestaciones_CostoPredeterminad_idx` (`CostoPredeterminados_id`),
  ADD KEY `fk_CostoPredeterminados_has_Prestaciones_Constantes1_idx` (`Constantes_id`);
...
ALTER TABLE `costos`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_Costos_General1_idx` (`General_id`);
...
--
-- Indexes for table `decreto_has_tipo`
--
ALTER TABLE `decreto_has_tipo`
  ADD PRIMARY KEY (`Decreto_id`,`Tipo_id`),
  ADD KEY `fk_Decreto_has_Tipo_Tipo1_idx` (`Tipo_id`),
  ADD KEY `fk_Decreto_has_Tipo_Decreto1_idx` (`Decreto_id`);
...
--
-- Indexes for table `departamento_has_decreto`
--
ALTER TABLE `departamento_has_decreto`
  ADD PRIMARY KEY (`Departamento_id`,`Decreto_id`),
  ADD KEY `fk_Departamento_has_Decreto_Decreto1_idx` (`Decreto_id`),
  ADD KEY `fk_Departamento_has_Decreto_Departamento1_idx` (`Departamento_id`);

--
-- Indexes for table `dialaborables`
--
ALTER TABLE `dialaborables`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_diaLaborables_referencia1_idx` (`Referencia_id`);
...
--
-- Indexes for table `equipos_has_general`
--
ALTER TABLE `equipos_has_general`
  ADD PRIMARY KEY (`Equipos_id`,`General_id`),
  ADD KEY `fk_Equipos_has_General_General1_idx` (`General_id`),
  ADD KEY `fk_Equipos_has_General_Equipos1_idx` (`Equipos_id`);
...
ALTER TABLE `general`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_General_Departamento1_idx` (`Departamento_id`),
  ADD KEY `fk_General_Decreto1_idx` (`Decreto_id`),
  ADD KEY `fk_General_Clientes1_idx` (`Clientes_id`),
  ADD KEY `fk_General_Vendedor1_idx` (`Vendedor_id`);

--
-- Indexes for table `general_has_subtipo`
--
ALTER TABLE `general_has_subtipo`
  ADD PRIMARY KEY (`General_id`,`SubTipo_id`),
  ADD KEY `fk_General_has_SubTipo_SubTipo1_idx` (`SubTipo_id`),
  ADD KEY `fk_General_has_SubTipo_General1_idx` (`General_id`);

--
-- Indexes for table `general_has_tipo`
--
ALTER TABLE `general_has_tipo`
  ADD PRIMARY KEY (`General_id`,`Tipo_id`),
  ADD KEY `fk_General_has_Tipo_Tipo1_idx` (`Tipo_id`),
  ADD KEY `fk_General_has_Tipo_General1_idx` (`General_id`);
...
ALTER TABLE `limites`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_Limites_Departamento1_idx` (`Departamento_id`),
  ADD KEY `fk_Limites_Decreto1_idx` (`Decreto_id`),
  ADD KEY `fk_Limites_Tipo1_idx` (`Tipo_id`),
  ADD KEY `fk_Limites_SubTipo1_idx` (`SubTipo_id`),
  ADD KEY `fk_Limites_Caracterizacion1_idx` (`Caracterizacion_id`),
  ADD KEY `fk_Limites_Rama1_idx` (`Rama_id`);
...
ALTER TABLE `muestras`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_Muestras_General1_idx` (`General_id`);
...
ALTER TABLE `ordencompra`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_ordenCompra_peticion1_idx` (`Peticion_id`);
...
ALTER TABLE `parametros`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_Parametros_General1_idx` (`General_id`),
  ADD KEY `fk_Parametros_Limites1_idx` (`Limites_id`);

--
-- Indexes for table `parametros_has_muestras`
--
ALTER TABLE `parametros_has_muestras`
  ADD PRIMARY KEY (`Parametros_id`,`Muestras_id`),
  ADD KEY `fk_Parametros_has_Muestras_Muestras1_idx` (`Muestras_id`),
  ADD KEY `fk_Parametros_has_Muestras_Parametros1_idx` (`Parametros_id`);

--
-- Indexes for table `parametros_has_muestras_has_costopredeterminados`
--
ALTER TABLE `parametros_has_muestras_has_costopredeterminados`
  ADD PRIMARY KEY (`Parametros_has_Muestras_Parametros_id`,`Parametros_has_Muestras_Muestras_id`,`CostoPredeterminados_id`),
  ADD KEY `fk_Parametros_has_Muestras_has_CostoPredeterminados_CostoPr_idx` (`CostoPredeterminados_id`),
  ADD KEY `fk_Parametros_has_Muestras_has_CostoPredeterminados_Paramet_idx` (`Parametros_has_Muestras_Parametros_id`,`Parametros_has_Muestras_Muestras_id`);

--
-- Indexes for table `peticion`
--
ALTER TABLE `peticion`
  ADD PRIMARY KEY (`id`,`General_id`,`Muestras_id`,`Referencia_id`),
  ADD KEY `fk_peticion_referencia1_idx` (`Referencia_id`),
  ADD KEY `fk_peticion_General1_idx` (`General_id`),
  ADD KEY `fk_peticion_Muestras1_idx` (`Muestras_id`),
  ADD KEY `fk_Peticion_Costos1_idx` (`Costos_id`),
  ADD KEY `fk_Peticion_Reporte1_idx` (`Reporte_id`);
...
ALTER TABLE `plantilla`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_reporte_Vendedor1_idx` (`Vendedor_id`),
  ADD KEY `fk_reporte_Departamento1_idx` (`Departamento_id`);
...
--
-- Indexes for table `rama_has_caracterizacion`
--
ALTER TABLE `rama_has_caracterizacion`
  ADD PRIMARY KEY (`Rama_id`,`Caracterizacion_id`),
  ADD KEY `fk_Rama_has_Caracterizacion_Caracterizacion1_idx` (`Caracterizacion_id`),
  ADD KEY `fk_Rama_has_Caracterizacion_Rama1_idx` (`Rama_id`);

--
-- Indexes for table `rama_has_general`
--
ALTER TABLE `rama_has_general`
  ADD PRIMARY KEY (`Rama_id`,`General_id`),
  ADD KEY `fk_Rama_has_General_General1_idx` (`General_id`),
  ADD KEY `fk_Rama_has_General_Rama1_idx` (`Rama_id`);
...
ALTER TABLE `reporte`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_reporte_Plantilla1_idx` (`Plantilla_id`);
...
--
-- Indexes for table `tipo_has_subtipo`
--
ALTER TABLE `tipo_has_subtipo`
  ADD PRIMARY KEY (`Tipo_id`,`SubTipo_id`),
  ADD KEY `fk_Tipo_has_SubTipo_SubTipo1_idx` (`SubTipo_id`),
  ADD KEY `fk_Tipo_has_SubTipo_Tipo1_idx` (`Tipo_id`);
...
ALTER TABLE `track`
  ...
  ADD KEY `fk_track_user1_idx` (`user_id`);
...
ALTER TABLE `vendedor`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_Vendedor_Puesto` (`Puesto_id`),
  ADD KEY `fk_Vendedor_user1` (`user_id`);
...
--
ALTER TABLE `caracterizacion`
  MODIFY `id` smallint(5) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=411;
--
-- AUTO_INCREMENT for table `carea`
--
ALTER TABLE `carea`
...
--
-- AUTO_INCREMENT for table `codigoanalisis`
--
ALTER TABLE `codigoanalisis`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `codigomuestra`
--
ALTER TABLE `codigomuestra`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
...
ALTER TABLE `constantes`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `costopredeterminados`
--
ALTER TABLE `costopredeterminados`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
...
--
-- AUTO_INCREMENT for table `dialaborables`
--
ALTER TABLE `dialaborables`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `limites`
  MODIFY `id` mediumint(8) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1170;
--
